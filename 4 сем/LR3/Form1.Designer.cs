    ...
    partial class Form1
    {
        ...
        Account ValidateAccount()
        {
            try
            {
                ...
                var acc = new Account(number, type, balance, date, owner, sms, iBanking);
                var res = new List<ValidationResult>();
                if(!Validator.TryValidateObject(acc, new ValidationContext(acc),res, true))
                {
                    string sRes = "";
                    foreach(var item in res)
                    {
                        sRes += item.ErrorMessage + "\n";
                    }
                    return null;
                }
                return acc;
        ...
        private void InitializeComponent()
        {
            ...
            this.listBox1.Location = new System.Drawing.Point(11, 313);
            ...
            this.checkBox1.Location = new System.Drawing.Point(11, 459);
            ...
            this.checkBox2.Location = new System.Drawing.Point(11, 484);
            ...
            // button2
            // 
            this.button2.Location = new System.Drawing.Point(11, 518);
            ...
            this.listBox2.Location = new System.Drawing.Point(218, 56);
            ...
            // button3
            // 
            this.button3.Location = new System.Drawing.Point(218, 403);
            ...
            // button4
            // 
            this.button4.Location = new System.Drawing.Point(218, 461);
            ...
            this.linkLabel1.Location = new System.Drawing.Point(218, 518);
            ...
            this.pictureBox1.Location = new System.Drawing.Point(218, 541);
            ...
            this.menuStrip1.Items.Add(search);
            this.menuStrip1.Items.Add(sort);
            this.menuStrip1.Items.Add(save);
            this.menuStrip1.Items.Add(about);
            this.menuStrip1.Items.Add(view);
            // 
            // search
            // 
            this.search.DropDownItems.Add(searchByNumber);
            this.search.DropDownItems.Add(searchByFIO);
            this.search.DropDownItems.Add(searchByBalance);
            this.search.DropDownItems.Add(searchByType);
            searchByBalance.Click += new EventHandler(searchByBalance_Click);
            searchByFIO.Click += new EventHandler(searchByFIO_Click);
            searchByNumber.Click += new EventHandler(searchByNumber_Click);
            searchByType.Click += new EventHandler(searchByType_Click);
            //
            // sort
            //
            this.sort.Click += new EventHandler(sort_Click);
            //
            // save
            //
            ...
            // about
            //
            this.about.Click += new EventHandler(about_Click);
            // 
            // view
            // 
            viewItem = new ToolStripMenuItem("Поиск") { Checked = true, CheckOnClick = true };
            viewItem.Click += new EventHandler(menuItem_CheckedChanged);
            view.DropDownItems.Add(viewItem);
            viewItem = new ToolStripMenuItem("Сортировать") { Checked = true, CheckOnClick = true };
            viewItem.Click += new EventHandler(menuItem_CheckedChanged);
            view.DropDownItems.Add(viewItem);
            viewItem = new ToolStripMenuItem("Сохранить") { Checked = true, CheckOnClick = true };
            viewItem.Click += new EventHandler(menuItem_CheckedChanged);
            view.DropDownItems.Add(viewItem);
            viewItem = new ToolStripMenuItem("О программе") { Checked = true, CheckOnClick = true };
            viewItem.Click += new EventHandler(menuItem_CheckedChanged);
            view.DropDownItems.Add(viewItem);
            // 
            // statusStrip1
            ...
            this.toolStripStatusLabel1.Text = "Объкты: 0";
            // 
            ...
            this.toolStripStatusLabel3.Text = "Дата и время:";
            // 
            ...
            this.ClientSize = new System.Drawing.Size(489, 642);
        ...
        private ToolStripMenuItem search = new ToolStripMenuItem("Поиск");
        private ToolStripMenuItem sort = new ToolStripMenuItem("Сортировать");
        private ToolStripMenuItem save = new ToolStripMenuItem("Сохранить");
        private ToolStripMenuItem about = new ToolStripMenuItem("О программе");
        private ToolStripMenuItem searchByNumber = new ToolStripMenuItem("По номеру");
        private ToolStripMenuItem searchByFIO = new ToolStripMenuItem("По ФИО");
        private ToolStripMenuItem searchByBalance = new ToolStripMenuItem("По балансу");
        private ToolStripMenuItem searchByType = new ToolStripMenuItem("По типу вклада");
        private ToolStripMenuItem view = new ToolStripMenuItem("Вид");
